  ...
  return (
    <main className="min-h-screen bg-gray-50 flex flex-col md:flex-row font-sans text-gray-900 overflow-hidden relative">
      ...
      <div className="flex-1 p-8 lg:p-16 flex flex-col relative z-10 hidden md:flex justify-center border-r border-gray-200">
        ...
        <Link
          href="/"
          className="absolute top-10 left-10 flex items-center gap-2 mb-20 z-10 w-fit hover:opacity-80 transition-opacity"
        >
          ...
          <span className="font-bold text-xl tracking-wide uppercase text-gray-900">
            Connectify
          </span>
        </Link>
        ...
        <div className="z-10 max-w-lg">
          ...
          <p className="text-gray-500 text-lg mb-10">
            Join millions of people and explore the world through meaningful,
          ...
          <div className="grid grid-cols-1 gap-6">
            ...
            <div className="flex items-center gap-4 clay-card p-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">
                  Meet and collaborate with people from around the world.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="w-full max-w-md clay-card p-8 md:p-10 my-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 text-sm">
              Let&apos;s get you started with Connectify
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            <button
              ...
              type="button"
              className="flex items-center justify-center gap-2 py-3 rounded-xl bg-white border border-gray-100 hover:bg-gray-50 transition-colors text-sm font-bold text-gray-700 shadow-sm"
            >
          ...
          <form className="flex flex-col gap-5" onSubmit={handleSignup}>
            ...
            <button
              disabled={loading}
              type="submit"
              className="w-full py-3.5 bg-blue-600 text-white rounded-xl font-bold mt-2 clay-btn hover:bg-blue-700"
            >
            ...
            <div className="flex w-full justify-center items-center text-sm font-medium mt-6 pt-6 border-t border-gray-100">
              ...
              <Link
                href="/login"
                className="ml-2 px-6 py-2.5 rounded-full clay-btn-white text-blue-600 font-bold hover:text-blue-700"
              >
                Log in
              </Link>
            </div>
